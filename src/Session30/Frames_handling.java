...
public class Frames_handling 
{
	...
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.xpath("//input[@name='mytext2']")).sendKeys("manoj");
		driver.switchTo().defaultContent();
		
		//Frame3
		WebElement frame3=driver.findElement(By.xpath("//frame[@src='frame_3.html']"));
		driver.switchTo().frame(frame3);
		driver.findElement(By.xpath("//input[@name='mytext3']")).sendKeys("manoj");
		driver.findElement(By.xpath("//div[@id='i8']//div[@class='AB7Lab Id5V1']")).click();
		//WebElement rdbtn=driver.findElement(By.xpath("//div[@id='i8']//div[@class='AB7Lab Id5V1']"));
		//JavascriptExecutor js=(JavascriptExecutor)driver;
		//js.executeScript("argument[0].click()", rdbtn);
		//driver.switchTo().defaultContent();
